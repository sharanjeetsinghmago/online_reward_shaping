...
def color_detect(img): # assign reward value: -1
    ...
    return mask1_red+mask2_red, mask1_lgray+mask2_lgray, mask_dgray, mask1_spink+mask2_spink, mask_white, mask_yellow, mask_green, mask_star
...
def image2reward(image_file):
    ...
    mask_red, mask_lgray, mask_dgray, mask_spink, mask_white, mask_yellow, mask_green, mask_star = color_detect(img)
    ...
    discrete_matshow(rewardMatrix,"../img/image2reward_with_rrt.png",rewardMatrix.min(),rewardMatrix.max())
